    ...
    def create_session(
        ...
        self.set_session(
            ["version"],
            {
                ...
                "pip_lib_smoother_version": version("libsmoother"),
                "lib_smoother_version": LIB_SMOOTHER_CPP_VERSION,
                "lib_smoother_build_time": LIB_SMOOTHER_CPP_BUILD_TIME,
            },
        )
