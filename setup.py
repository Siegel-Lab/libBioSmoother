...
class CMakeBuild(build_ext):
    def build_extension(self, ext: CMakeExtension) -> None:
        ...
        cmake_args = [
            ...
            f"-DPython_LIBRARY={sysconfig.get_config_var('LIBDIR')}", # @todo these can cause issues apparently
            f"-DPython_INCLUDE_DIR={sysconfig.get_path('include')}", # @todo these can cause issues apparently
